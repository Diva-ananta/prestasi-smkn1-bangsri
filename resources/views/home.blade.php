...
<div class="min-h-screen bg-slate-50 dark:bg-slate-950">
    ...
    <section class="reveal reveal-right mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
        <div class="mb-12 flex flex-col justify-between gap-4 sm:flex-row sm:items-center animate-fade-in">
            ...
            <a href="{{ route('public.prestasi.index') }}" class="inline-flex items-center gap-2 rounded-lg bg-emerald-600 px-4 py-2.5 text-sm font-bold text-white transition hover:bg-emerald-700 shadow-lg shadow-emerald-600/30">
    ...
    <section class="reveal reveal-left bg-white py-16 dark:bg-slate-900">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="mb-8 flex flex-col justify-between gap-4 sm:flex-row sm:items-end">
                ...
                <a href="{{ route('public.siswa.search') }}" class="inline-flex items-center gap-2 rounded-lg bg-emerald-600 px-4 py-2.5 text-sm font-bold text-white transition hover:bg-emerald-700 shadow-lg shadow-emerald-600/30">
                    Lihat semua <i class="fas fa-arrow-right"></i>
                </a>
            </div>
