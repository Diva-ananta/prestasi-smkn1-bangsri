    ...
    <section class="border-b border-emerald-100 bg-white dark:border-slate-800 dark:bg-slate-900">
        <div class="mx-auto max-w-7xl px-4 pb-10 pt-12 text-center sm:px-6 lg:px-8 lg:pb-14 lg:pt-16">
            ...
            <div class="mt-6 flex flex-wrap justify-center gap-2">
                <button type="button" @click="activeCatalog = 'all'" :class="activeCatalog === 'all' ? 'bg-emerald-600 text-white' : 'bg-white text-slate-600 dark:bg-slate-900 dark:text-slate-300'" class="rounded-full border border-emerald-200 px-4 py-2 text-sm font-bold shadow-sm transition hover:-translate-y-0.5 hover:shadow-md active:translate-y-0 dark:border-slate-700">Semua</button>
                <button type="button" @click="activeCatalog = 'youtube'" :class="activeCatalog === 'youtube' ? 'bg-red-600 text-white' : 'bg-white text-slate-600 dark:bg-slate-900 dark:text-slate-300'" class="rounded-full border border-slate-200 px-4 py-2 text-sm font-bold shadow-sm transition hover:-translate-y-0.5 hover:shadow-md active:translate-y-0 dark:border-slate-700"><i class="fab fa-youtube mr-1.5"></i>YouTube</button>
                <button type="button" @click="activeCatalog = 'tiktok'" :class="activeCatalog === 'tiktok' ? 'bg-slate-900 text-white dark:bg-white dark:text-slate-900' : 'bg-white text-slate-600 dark:bg-slate-900 dark:text-slate-300'" class="rounded-full border border-slate-200 px-4 py-2 text-sm font-bold shadow-sm transition hover:-translate-y-0.5 hover:shadow-md active:translate-y-0 dark:border-slate-700"><i class="fab fa-tiktok mr-1.5"></i>TikTok</button>
                <button type="button" @click="activeCatalog = 'instagram'" :class="activeCatalog === 'instagram' ? 'bg-pink-600 text-white' : 'bg-white text-slate-600 dark:bg-slate-900 dark:text-slate-300'" class="rounded-full border border-slate-200 px-4 py-2 text-sm font-bold shadow-sm transition hover:-translate-y-0.5 hover:shadow-md active:translate-y-0 dark:border-slate-700"><i class="fab fa-instagram mr-1.5"></i>Instagram</button>
                <button type="button" @click="activeCatalog = 'foto'" :class="activeCatalog === 'foto' ? 'bg-blue-600 text-white' : 'bg-white text-slate-600 dark:bg-slate-900 dark:text-slate-300'" class="rounded-full border border-slate-200 px-4 py-2 text-sm font-bold shadow-sm transition hover:-translate-y-0.5 hover:shadow-md active:translate-y-0 dark:border-slate-700"><i class="fas fa-image mr-1.5"></i>Foto</button>
            </div>
