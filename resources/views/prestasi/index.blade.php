...
<div class="min-h-screen bg-slate-50 dark:bg-slate-950">
    ...
    <section x-data="{ filtersOpen: false }" class="mx-auto max-w-7xl px-4 py-9 sm:px-6 lg:px-8 lg:py-10">
        ...
        <div class="grid items-start gap-5 lg:grid-cols-[240px_minmax(0,1fr)]">
                <div x-show="filtersOpen" x-cloak @click.self="filtersOpen = false" class="fixed inset-0 z-40 bg-slate-950/40 backdrop-blur-sm lg:static lg:z-auto lg:!block lg:bg-transparent lg:backdrop-blur-none lg:self-start lg:sticky lg:top-24">
                    <aside class="h-fit w-[min(88vw,320px)] bg-white p-4 shadow-xl dark:bg-slate-900 lg:w-auto lg:rounded-2xl lg:border lg:border-slate-200 lg:shadow-sm dark:lg:border-slate-700" @click.stop>
