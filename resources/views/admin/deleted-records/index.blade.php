...
<div class="page-shell">
    <div class="page-header animate-fade-in"><p class="mb-2 text-[11px] font-semibold uppercase tracking-[0.24em] text-emerald-200">Pemeliharaan Data</p><h1 class="text-2xl font-bold md:text-3xl">Riwayat Data Dihapus</h1><p class="mt-2 text-sm">Pulihkan atau hapus permanen data yang dihapus oleh admin.</p></div>
    <div class="section-card p-0"><div class="admin-table-wrap rounded-none border-0 shadow-none"><table class="admin-table min-w-[680px] w-full"><thead><tr><th>Data</th><th>Dihapus oleh</th><th>Waktu</th><th>Aksi</th></tr></thead><tbody>
    ...
    </tbody></table></div><div class="mt-4 px-4 pb-4">{{ $records->links() }}</div></div>
</div>
@endsection
