    ...
    <div class="page-header animate-fade-in">
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <h1 class="text-2xl font-bold text-slate-800 dark:text-white md:text-3xl">Tambah Prestasi</h1>
                <p class="mt-1 text-sm text-slate-500 dark:text-slate-300">Lengkapi detail di bawah untuk menambahkan capaian siswa baru.</p>
            </div>
        </div>
    </div>

    <div class="admin-form-bubble animate-fade-in p-6 md:p-8">
        <form method="POST" action="{{ route('admin.prestasi.store') }}" enctype="multipart/form-data" data-ajax-form>
            @csrf
